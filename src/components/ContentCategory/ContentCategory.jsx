    ...
    return (
        <>
            <div className='content__top'>
                <h2 style={{color: 'lightblue'}} className='content__title'>{status}</h2>
                <span className='content__title-edit'>
                    ...
                    status !== 'all' ? 
                        user.categories.find((item)=> item.categoryName === status).tasks.map(item => (
                            <li key={item.id} className='content__item'>
                                ...
                                <span className='content__item-text'>{item.taskTitle}</span>
                                <span className='content__item-remove'/>
                            </li>
                        )) : ''
                }          
            </ul>
            ...
            {
                status !== 'all' && <div className='content__bottom'>
                <span className='content__bottom-icon'>
                ...
                <span className='content__bottom-text'>New task</span>
            </div> 
